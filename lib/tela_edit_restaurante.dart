...
class TelaEditRestauranteState extends State<TelaEditRestaurante>{
  ...
  void initState(){
    ...
    culinariaSelecionada = TelaEditRestaurante.restaurante.culinaria?.nome!;
  }
      ...
      body: Padding(padding: const EdgeInsets.all(30),
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
                onPressed: () async{
                  final resultado = await RestauranteDAO.cadastrarRestaurante(
                  ...
                  if(resultado > 0){
                    msg = '"${nomeController.text}" cadastrado com sucesso! ID: $resultado';
